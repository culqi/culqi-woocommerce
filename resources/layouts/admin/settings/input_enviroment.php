<input type="radio" name="fullculqi_options[enviroment]" value="<?php echo URLAPI_ORDERCHARGES_INTEG; ?>|<?php echo URLAPI_CHECKOUT_INTEG; ?>|<?php echo URLAPI_INTEG_3DS; ?>|integ" <?php echo ($enviroment === URLAPI_ORDERCHARGES_INTEG.'|'.URLAPI_CHECKOUT_INTEG.'|'.URLAPI_INTEG_3DS.'|integ' or $enviroment=='' or is_null($enviroment)) ? 'checked="true"' : '' ; ?> id="integracion" data-urllogin="<?php echo URLAPI_LOGIN_INTEG ?>" data-urlmerchant="<?php echo URLAPI_MERCHANT_INTEG ?>" data-urlmerchantsingle="<?php echo URLAPI_MERCHANTSINGLE_INTEG ?>" data-urlwebhook="<?php echo URLAPI_WEBHOOK_INTEG ?>" /> <label for="integracion">Integración</label>
<input style="margin-left: 25px" type="radio" name="fullculqi_options[enviroment]" value="<?php echo URLAPI_ORDERCHARGES_PROD; ?>|<?php echo URLAPI_CHECKOUT_PROD; ?>|<?php echo URLAPI_PROD_3DS; ?>|prod" <?php echo ($enviroment === URLAPI_ORDERCHARGES_PROD.'|'.URLAPI_CHECKOUT_PROD.'|'.URLAPI_PROD_3DS.'|prod') ? 'checked="true"' : '' ; ?> id="produccion" data-urllogin="<?php echo URLAPI_LOGIN_PROD ?>" data-urlmerchant="<?php echo URLAPI_MERCHANT_PROD ?>" data-urlmerchantsingle="<?php echo URLAPI_MERCHANTSINGLE_PROD ?>" data-urlwebhook="<?php echo URLAPI_WEBHOOK_PROD ?>" /> <label for="produccion"> Producción</label>
</td>
</tr>
<tr>
