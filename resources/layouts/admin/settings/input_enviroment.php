<input type="radio" name="fullculqi_options[enviroment]" value="<?php echo FULLCULQI_URLAPI_ORDERCHARGES_INTEG; ?>|<?php echo FULLCULQI_URLAPI_CHECKOUT_INTEG; ?>|<?php echo FULLCULQI_URLAPI_INTEG_3DS; ?>|integ" <?php echo ($enviroment === FULLCULQI_URLAPI_ORDERCHARGES_INTEG.'|'.FULLCULQI_URLAPI_CHECKOUT_INTEG.'|'.FULLCULQI_URLAPI_INTEG_3DS.'|integ' or $enviroment=='' or is_null($enviroment)) ? 'checked="true"' : '' ; ?> id="integracion" data-urllogin="<?php echo FULLCULQI_URLAPI_LOGIN_INTEG ?>" data-urlmerchant="<?php echo FULLCULQI_URLAPI_MERCHANT_INTEG ?>" data-urlmerchantsingle="<?php echo FULLCULQI_URLAPI_MERCHANTSINGLE_INTEG ?>" data-urlwebhook="<?php echo FULLCULQI_URLAPI_WEBHOOK_INTEG ?>" /> <label for="integracion">Integración</label>
<input style="margin-left: 25px" type="radio" name="fullculqi_options[enviroment]" value="<?php echo FULLCULQI_URLAPI_ORDERCHARGES_PROD; ?>|<?php echo FULLCULQI_URLAPI_CHECKOUT_PROD; ?>|<?php echo FULLCULQI_URLAPI_PROD_3DS; ?>|prod" <?php echo ($enviroment === FULLCULQI_URLAPI_ORDERCHARGES_PROD.'|'.FULLCULQI_URLAPI_CHECKOUT_PROD.'|'.FULLCULQI_URLAPI_PROD_3DS.'|prod') ? 'checked="true"' : '' ; ?> id="produccion" data-urllogin="<?php echo FULLCULQI_URLAPI_LOGIN_PROD ?>" data-urlmerchant="<?php echo FULLCULQI_URLAPI_MERCHANT_PROD ?>" data-urlmerchantsingle="<?php echo FULLCULQI_URLAPI_MERCHANTSINGLE_PROD ?>" data-urlwebhook="<?php echo FULLCULQI_URLAPI_WEBHOOK_PROD ?>" /> <label for="produccion"> Producción</label>
</td>
</tr>
<tr>
