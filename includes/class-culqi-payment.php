...
class WC_Gateway_Culqi extends WC_Payment_Gateway
{
    ...
    public function process_payment($order_id)
    {
        ...
        $is_block = isset($_POST['culqi_checkout_type']) // phpcs:ignore WordPress.Security.NonceVerification.Missing
            && sanitize_text_field(wp_unslash($_POST['culqi_checkout_type'])) === 'block'; // phpcs:ignore WordPress.Security.NonceVerification.Missing
